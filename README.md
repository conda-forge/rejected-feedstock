...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3514&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rejected-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rejected` can be installed with `conda`:
...
```
mamba install rejected
```

It is possible to list all of the versions of `rejected` available on your platform with `conda`:
...
```
mamba search rejected --channel conda-forge
```
...
mamba repoquery search rejected --channel conda-forge

# List packages depending on `rejected`:
mamba repoquery whoneeds rejected --channel conda-forge

# List dependencies of `rejected`:
mamba repoquery depends rejected --channel conda-forge
```
